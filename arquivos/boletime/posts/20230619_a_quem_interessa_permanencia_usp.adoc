...
// :page-subtitle: 
:page-id: 20230619_a_quem_interessa_permanencia_usp
...
[.img]
--
image::boletime/posts/{page-id}/usp_diversa.jpg['Capa de uma apresentação do USP diversa, com a logo do programa em laranja e escrito abaixo em azul: "Programa Extraorçamentário de Promoção da Diversidade Estudantil"']
