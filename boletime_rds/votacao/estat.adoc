...
- +++<a href="{{ site.data._rds.eleicao_rds_2024.mae_conselho.link }}">{{ site.data._rds.eleicao_rds_2024.mae_conselho.titulo }}</a>+++
- +++<a href="{{ site.data._rds.eleicao_rds_2024.mae_coc.link }}">{{ site.data._rds.eleicao_rds_2024.mae_coc.titulo }}</a>+++